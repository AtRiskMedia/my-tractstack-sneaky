...
export const hasCustomImage = [
  ...
  'class-hipster',
  'class-deranged',
  'attack-double-cigarette-burn',
  'attack-double-lipstick-poison',
  'attack-double-spade-attack',
  'attack-drill',
  'attack-drone-strike',
  'attack-drool',
  'attack-dumbbell-slam',
  'attack-dynamite',
  'attack-elegant-requiem',
  'attack-existential-blow',
  'attack-extreme-farting',
  'attack-extreme-shaking',
  'attack-fart-gun',
  'attack-fart',
  'attack-feather-fury',
  'attack-fill-tool-fury',
  'attack-firestorm',
  'attack-flag-sign',
  'attack-abyss-gaze',
