  ...
  return (
    <div className="space-y-1">
      ...
      <div
        ...
        className={`rounded-md border-0 px-2.5 py-1.5 text-gray-900 ring-1 ring-inset ${disabled ? 'bg-gray-100 text-gray-500' : 'ring-gray-300 focus:ring-2 focus:ring-cyan-700'}`}
        style={{ minHeight: '1em' }}
