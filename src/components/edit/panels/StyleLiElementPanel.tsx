    ...
    if (liDefaultClasses) {
      Object.keys(liDefaultClasses.mobile).forEach((className) => {
        result[className] = {
          ...
          ...(liDefaultClasses.tablet && {
            tablet: liDefaultClasses.tablet[className],
          }),
          ...(liDefaultClasses.desktop && {
            desktop: liDefaultClasses.desktop[className],
          }),
        };
      });
    }
    ...
    if (liOverrideClasses) {
      ['mobile', 'tablet', 'desktop'].forEach((viewport) => {
        const viewportOverrides =
          liOverrideClasses[viewport as keyof typeof liOverrideClasses];
